...
module.exports = function () {
    ...
    function request(type, data, callback) {
        ...
        payload.security_hash = crypto.createHash('md5').update(unixTime + settings.credentials.api_key).digest('hex');
        // add config options
        ...
        var reqUrl = settings.url + type;


        debugLog('Request URL', reqUrl);
